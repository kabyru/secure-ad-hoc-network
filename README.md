...
The (D)SAN uses the following heirarchy for the sake of distributing *Proxy Certificates* to network nodes:
...
## Flow of Operation
*Ack: Some of the operation of this program comes from Graarud's secure-ad-hoc-network. His work has been extremely helpful in creating this implementation and I would like acklowledge his breakthroughs in securing ad-hoc networks.*
